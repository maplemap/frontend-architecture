...
Приклад можна розширювати, додаючи нові slices (`orders`, `profile` тощо) або шари (наприклад, `processes`), дотримуючись того ж принципу: спочатку визначити бізнес-домен → шар → код.
